...
def main():
    ...
    # ========== 计算关键点 ==========
    all_points= compute_keypoints(WIDTH, HEIGHT, SCALE)
    
    # 验证关键点数量
    assert len(all_points) == 9, f"关键点数量应为9，实际为{len(all_points)}"
    ...
    # ========== 输出关键点到文件 ==========
    txt_path = "target_simplified.txt"
    ...
    # 保存带标注的图像
    annotated_path = "target_simplified_annotated.png"
